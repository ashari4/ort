...
static onnx::OpSchema CreateTransformerDecoderGradSchema() {
  ...
  schema.SetDomain(onnxruntime::kMSDomain);
  schema.SinceVersion(BaselineOpsetVersion);
  schema.SetSupportLevel(onnx::OpSchema::SupportType::EXPERIMENTAL);
  schema.SetDoc("Backward Pass Node for Single Layer of Custom Transformer TNLG");
  schema.AllowUncheckedAttributes();
  schema.Input(0, "normalization weight 1", "input to transformer.", "T");
  schema.Input(1, "query weight", "input to transformer.", "T");
  schema.Input(2, "key weight", "input to transformer.", "T");
  schema.Input(3, "value weight", "input to transformer.", "T");
  schema.Input(4, "attention mask", "input to transformer.", "T");
  schema.Input(5, "project weight", "input to transformer.", "T");
  schema.Input(6, "feedforward neural network 1", "input to transformer.", "T");
  schema.Input(7, "feedforward neural network 2", "input to transformer.", "T");
  schema.Input(8, "normalization weight 2", "input to transformer.", "T");
  schema.Input(9, "pad values", "input to transformer.", "T");
  schema.Input(10, "Y0 gradient", "gradient tensor from output.", "T");
  schema.Input(11, "layer norm", "output of transformer.", "T");
  schema.Input(12, "std inv DMemAddr", "output of transformer..", "T");
  schema.Input(13, "shift DMemAddr", "output of transformer.", "T");
  schema.Input(14, "query DMem", "output of transformer.", "T");
  schema.Input(15, "key DMem", "output of transformer.", "T");
  schema.Input(16, "value DMem", "output of transformer.", "T");
  schema.Input(17, "softmax DMem", "output of transformer.", "T");
  schema.Input(18, "soft dropout DMem", "output of transformer.", "T");
  schema.Input(19, "soft dropout mask DMem", "output of transformer.", "T");
  schema.Input(20, "vsoft DMem", "output of transformer.", "T");
  schema.Input(21, "dense dropout mask DMem", "output of transformer.", "T");
  schema.Input(22, "post selfattention layer norm", "output of transformer.", "T");
  schema.Input(23, "normalization std inv DMemAddr", "output of transformer.", "T");
  schema.Input(24, "normalization shift DMemAddr", "output of transformer.", "T");
  schema.Input(25, "multilayer perceptron dense", "output of transformer.", "T");
  schema.Input(26, "multilayer perceptron gelu", "output of transformer.", "T");
  schema.Input(27, "multilayer perceptron dropout mask", "output of transformer.", "T");
  schema.Output(0, "normalization weight grad 1", "gradient of weight.", "T");
  schema.Output(1, "normalization bias grad 1", "gradient of bias.", "T");
  schema.Output(2, "query weight grad", "gradient of weight.", "T");
  schema.Output(3, "query bias grad", "gradient of bias.", "T");
  schema.Output(4, "key weight grad", "gradient of weight.", "T");
  schema.Output(5, "key bias grad", "gradient of bias.", "T");
  schema.Output(6, "value weight grad", "gradient of weight.", "T");
  schema.Output(7, "value bias grad", "gradient of bias.", "T");
  schema.Output(8, "attention dense weight", "gradient of weight.", "T");
  schema.Output(9, "dense bias grad", "gradient of bias.", "T");
  schema.Output(10, "multilayer perceptron dense weight 1", "gradient of weight.", "T");
  schema.Output(11, "multilayer perceptron bias grad 1", "gradient of bias.", "T");
  schema.Output(12, "multilayer perceptron dense weight 2", "gradient of weight.", "T");
  schema.Output(13, "multilayer perceptron bias grad 2", "gradient of bias.", "T");
  schema.Output(14, "normalization weight grad 2", "gradient of weight.", "T");
  schema.Output(15, "normalization bias grad 2", "gradient of bias.", "T");
  schema.Output(16, "output grad", "gradient of the input.", "T");
  schema.Attr("paddedHiddenSize", "padded hidden size", ONNX_NAMESPACE::AttributeProto::INT, static_cast<int64_t>(1024));
  schema.Attr("headSize", "head size", ONNX_NAMESPACE::AttributeProto::INT, static_cast<int64_t>(64));
  schema.Attr("numHeads", "number of heads", ONNX_NAMESPACE::AttributeProto::INT, static_cast<int64_t>(8))  ;
  return schema;
...
onnxruntime::ORTInvoker& ORTBackendsManager::GetInvoker(const at::Device device) {
  ...
  std::vector<onnx::OpSchema> schemas{CreateTransformerDecoderSchema(), CreateTransformerDecoderGradSchema()};
